...
stepwise(modele_1, direction='backward/forward', criterion='AIC')
stepwise(modele_2, direction='backward/forward', criterion='AIC')
stepwise(modele_1, direction='backward/forward', criterion='BIC')
stepwise(modele_2, direction='backward/forward', criterion='BIC')
